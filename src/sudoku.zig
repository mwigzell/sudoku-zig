    ...
    return struct {
        ...
        fn handleResult(self: *@This(), out: anytype, in_: anytype, renderer: anytype, io: std.Io, result: command.ParseCommandResult) anyerror!bool {
            switch (result) {
                ...
                .valid => |cmd| {
                    _ = io; // used inside exec() via engine._io
                    ...
                    return self.handleEvent(out, in_, renderer, event) catch |err| {
                        var buf: [80]u8 = undefined;
...
var mr = MockReader.initMockReader(&[_][]const u8{});
    ...
    _ = sudoku.handleResult(&mw, &mr, &mock, std.testing.io, parsed_save) catch |err| {
...
test "handleResult: subsequent save reuses previous filename with feedback" {
    ...
    _ = try sudoku.handleResult(&mw1, &mr, &mock, std.testing.io, parsed_save_1);
    ...
    _ = try sudoku.handleResult(&mw2, &mr, &mock, std.testing.io, parsed_save_2);
