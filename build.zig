...
pub fn build(b: *std.Build) void {
    ...
    const glue = b.addSystemCommand(&.{ "sh", "-c", "node src/wasm/artifacts/glue.test.mjs && node src/wasm/board.test.mjs && node src/wasm/menu.test.mjs && node src/wasm/menu_bar.test.mjs && node src/wasm/theme.test.mjs" });
