...
- [ ] Obsolete files removed; `src/root.zig` imports final module set — blocked pending 15.5.
- [ ] No wrapper-only test paths — all tests exercise same code main() uses — blocked pending MockRenderer update in 15.5.
